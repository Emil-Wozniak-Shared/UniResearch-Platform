...
import infrastructure.user.model.result.ListEagerUserRolesResult
...
interface UserRolePersistencePort {
    ...
    suspend fun listEager(event: ListEagerUserRolesEvent, tx: Transaction): ListEagerUserRolesResult
}
